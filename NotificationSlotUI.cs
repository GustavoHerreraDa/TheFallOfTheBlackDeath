...
/// <summary>
/// A single toast notification row with proper layout control.
...
///   ├── LayoutElement (Script) — CRITICAL: Preferred Height = ~80, Layout Priority = 1
...
public class NotificationSlotUI : MonoBehaviour
{
    ...
    [Header("Layout")]
    [Tooltip("Preferred height for this notification slot. Should match your design.")]
    public float preferredHeight = 80f;

    [Tooltip("Preferred width for this notification slot.")]
    public float preferredWidth = 400f;
    ...
    private void Awake()
    {
        ...
        // CRÍTICO: Configurar el LayoutElement para evitar superposición
        if (layoutElement != null)
        {
            layoutElement.preferredHeight = preferredHeight;
            layoutElement.preferredWidth = preferredWidth;
            layoutElement.layoutPriority = 1; // Prioritario en el cálculo del layout
        }

        // Ensure RectTransform anchors are correct (stretch top)
        if (rt != null)
        {
