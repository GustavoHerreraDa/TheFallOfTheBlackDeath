...
public class FloatingText : MonoBehaviour
{
    ...
    /// </summary>
    public void Initialize(string message, Color color, bool isCritical, bool useRandomOffset = true)
    {
    ...
    void Update()
    {
        ...
        // Usamos mainCamera.forward en vez del vector directo texto→cámara:
        // evita inestabilidad cuando ambos comparten casi la misma posición,
        // y es consistente con el comportamiento de Canvas en World Space.
        if (mainCamera != null)
